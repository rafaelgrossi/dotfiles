...
local wallpaper="/home/raech/Pictures/Wallpaper/mapleretro.mp4"
...
floating_terminal = "st -c fst" -- clients with class "fst" are set to be floating (check awful.rules below)
nnn = "st nnn"
browser = "firefox"
filemanager = "nemo"
editor = "vim"
...
mymainmenu = awful.menu({ items = {
    ...
    { "search", "dmenu", beautiful.search_icon },
    { "discord",
    function ()
...
local function set_wallpaper(s)
    ...
    if beautiful.wallpaper then
        ...
        -- Method 3: Set last wallpaper with feh
         awful.spawn.with_shell(os.getenv("HOME") .. "/bin/gifwp " .. wallpaper)
	--awful.spawn.with_shell("xwinwrap -ni -fdt -un -b -nf -ov -fs -- gifview -w WID /home/raech/Pictures/Wallpapers/fish.gif -a")
    end
end
...
awful.screen.connect_for_each_screen(function(s)
    ...
    local l = awful.layout.suit -- Alias to save time :)
     local layouts = { l.tile, l.max, l.tile, l.tile , l.tile, l.max, l.max, l.max, l.max, l.tile}
    --local layouts = { l.max, l.max, l.max, l.tile , l.tile, l.max, l.max, l.max, l.tile, l.max}
