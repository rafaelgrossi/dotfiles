...
mytextdate.markup = helpers.colorize_text(mytextdate.text, beautiful.xcolor1)
...
local datetime = require("noodle.date_text")
local datetime_icon = datetime:get_all_children()[1]
local datetime_text = datetime:get_all_children()[2]
datetime_icon.font = "Typicons 5"
datetime_text.font = "sans 9"
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.traybox.x = s.geometry.width - beautiful.screen_margin - s.traybox.width
    s.traybox.y = s.geometry.height - beautiful.screen_margin*90 - 55
    ...
    weather_widget_icon.font = "Typicons 15"
	...
	if beautiful.wibar_detached then
   		s.useless_wibar = awful.wibar({ position = beautiful.wibar_position, screen=s, height = 15, opacity = 0 })
	end
