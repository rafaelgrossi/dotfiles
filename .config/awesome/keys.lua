...
keys.globalkeys = gears.table.join(
    ...
    awful.key({ superkey }, "r",
      function()
        awful.spawn.with_shell("menu run -p 'Run: '")
      end,
    ...
    awful.key( { }, "XF86MonBrightnessDown",
      function()
        ...
        awful.spawn.easy_async_with_shell("bright dec", function()
    ...
    awful.key( { }, "XF86MonBrightnessUp",
      function()
        ...
        awful.spawn.easy_async_with_shell("bright inc", function()
            awesome.emit_signal("brightness_changed")
        end)
      end,
    ...
    awful.key( { }, "XF86KbdBrightnessUp",
      function()
        -- awful.spawn.with_shell("xbacklight -dec 10")
        awful.spawn.easy_async_with_shell("kbdlight up 5", function()
            awesome.emit_signal("brightness_changed")
        end)
      end,
      {description = "decrease brightness", group = "brightness"}),
    awful.key( { }, "XF86KbdBrightnessDown",
      function()
        -- awful.spawn.with_shell("xbacklight -inc 10")
        awful.spawn.easy_async_with_shell("kbdlight down 5", function()
            awesome.emit_signal("brightness_changed")
        end)
      end,
      {description = "increase brightness", group = "brightness"}),
    ...
    awful.key( { }, "XF86AudioMute", function()
        awful.spawn.with_shell("volume toggle")
    end,
    ...
    -- Screenshots
    awful.key( { superkey, shiftkey }, "p", function() awful.spawn.with_shell("screenshot.sh") end,
    ...
    awful.key( { ctrlkey, shiftkey }, "p", function() awful.spawn.with_shell("screenshot.sh -b") end,
              {description = "browse screenshots", group = "screenshots"}),
    awful.key( { superkey, ctrlkey }, "e", function() awful.spawn.with_shell("screenshot.sh -e") end,
    ...
    awful.key({ superkey, ctrlkey }, "q", function() awful.spawn.with_shell("firefox") end,
    ...
    awful.key({ superkey }, "e", function() awful.spawn(terminal .. " -e nnn") end,
    ...
    -- Quick edit file
    awful.key({ superkey, shiftkey }, "e", function() awful.spawn.with_shell("~/scr/Rofi/rofi_edit") end,
    ...
    awful.key({ superkey, shiftkey }, "p", function() awful.spawn(terminal .. " -e gotop") end,
...
keys.clientkeys = gears.table.join(
    ...
    awful.key({ superkey, ctrlkey  }, "v",
      ...
      {description = "focus mode", group = "client"}),
    -- T for tiny window
    awful.key({ superkey, ctrlkey, shiftkey }, "t",
        function (c)
